...
public class CameraZoom : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //ZoomSet zoom4 = new ZoomSet(4.0f, 1.5f, 0.45f, 3f, 4.0f, 2.5f);
        //ZoomSet zoom5 = new ZoomSet(4.5f, 1.5f, 0.4f, 4f, 4.5f, 3f);
        //ZoomSet zoom6 = new ZoomSet(5.0f, 1.5f, 0.35f, 4.25f, 4.75f, 3.5f);
        //ZoomSet zoom7 = new ZoomSet(5.5f, 1.5f, 0.3f, 4.5f, 5f, 4f);
        //ZoomSet zoom8 = new ZoomSet(6.5f, 1.5f, 0f, 5f, 6.5f, 5);
